...
export function CreateItemModal({ collectionId }: CreateItemModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      submitFormData.append('collectionId', collectionId)
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new item to this collection. You can upload images from your device.
          </DialogDescription>
        </DialogHeader>
